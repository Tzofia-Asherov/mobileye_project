...
for i in range (24,28):
    ...
    curr_container = SFM.calc_TFL_dist(prev_container, curr_container, focal, pp, dis_3_traffic)

    #visualize(prev_container, curr_container, focal, pp)
print(dis_3_traffic) 
plt.plot(dis_3_traffic[0])
plt.plot(dis_3_traffic[1])
plt.plot(dis_3_traffic[2])
